...
public class KineticBatteryScene {
    ...
    public static void kineticBatteryAutomation(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntityNBT(util.select().position(deployer), DeployerBlockEntity.class, nbt -> nbt.put("HeldItem", PonderNbt.saveStack(scene.world().getHolderLookupProvider(), batteryStack)));

...
public class CopycatFenceGateModel extends CCCopycatModel {

    public CopycatFenceGateModel(BlockState state, UnbakedRoot unbaked) {
        super(state, unbaked);
    }
